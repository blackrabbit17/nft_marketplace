          ...
          <Slider {...settings}>
            <CustomSlide className='itm' index={1}>
              <div className="nft_pic">                            
                  ...
                  <div className="nft_pic_wrap">
                      ...
                      <img src="/static/img/carousel/crs-1.jpg" className="lazy img-fluid" alt=""/>
            ...
            <CustomSlide className='itm' index={2}>
             <div className="nft_pic">                            
                  ...
                  <div className="nft_pic_wrap">
                      <img src="/static/img/carousel/crs-2.jpg" className="lazy img-fluid" alt=""/>
                  </div>
              </div>
            </CustomSlide>
            ...
            <CustomSlide className='itm' index={3}>
              <div className="nft_pic">                            
                  ...
                  <div className="nft_pic_wrap">
                      <img src="/static/img/carousel/crs-3.jpg" className="lazy img-fluid" alt=""/>
                  </div>
              </div>
            </CustomSlide>
            ...
            <CustomSlide className='itm' index={4}>
              <div className="nft_pic">                            
                  ...
                  <div className="nft_pic_wrap">
                      <img src="/static/img/items/anim-5.webp" className="lazy img-fluid" alt=""/>
                  </div>
              </div>
            </CustomSlide>
            ...
            <CustomSlide className='itm' index={5}>
              <div className="nft_pic">                            
                  ...
                  <div className="nft_pic_wrap">
                      <img src="/static/img/items/anim-8.webp" className="lazy img-fluid" alt=""/>
                  </div>
              </div>
            </CustomSlide>
