...
const Collection = () => {
  ...
  return (
    ...
    <GlobalStyles/>
      ...
      <section id='profile_banner' className='jumbotron breadcumb no-bg' style={{backgroundImage: `url(${'/static/img/background/4.jpg'})`}}>
            ...
            <div className="d_profile">
                      <div className="profile_avatar">
                          <div className="d_profile_img">
                              <img src="/static/img/author/author-1.jpg" alt=""/>
