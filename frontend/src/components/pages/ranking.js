      ...
      <div className='container'>
        <div className='row m-10-hor'>
          <div className='col-12'>
            <h1 className='text-center text-dark'>Top NFTs</h1>
          </div>
        </div>
      </div>
    </div>
            ...
            <table className="table de-table table-rank">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row">
                  <div className="coll_list_pp">
                    <img className="lazy" src="/static/img/author/author-3.jpg" alt=""/>
                    <i className="fa fa-check"></i>
                  </div>  
                  Cartoonism</th>
                  <td>13,705.58</td>
                ...
                <tr>
                  <th scope="row">
                  <div className="coll_list_pp">
                    <img className="lazy" src="/static/img/author/author-4.jpg" alt=""/>
                    <i className="fa fa-check"></i>
                  </div>  
                  Papercut</th>
                  <td>12,516.75</td>
                ...
                <tr>
                  <th scope="row">
                  <div className="coll_list_pp">
                    <img className="lazy" src="/static/img/author/author-5.jpg" alt=""/>
                    <i className="fa fa-check"></i>
                  </div>  
                  Virtuland</th>
                  <td>11,586.26</td>
                ...
                <tr>
                  <th scope="row">
                  <div className="coll_list_pp">
                    <img className="lazy" src="/static/img/author/author-6.jpg" alt=""/>
                    <i className="fa fa-check"></i>
                  </div>  
                  CoolThings</th>
                  <td>10,645.96</td>
                ...
                <tr>
                  <th scope="row">
                  <div className="coll_list_pp">
                    <img className="lazy" src="/static/img/author/author-7.jpg" alt=""/>
                    <i className="fa fa-check"></i>
                  </div>  
                  DigiPunks</th>
                  <td>9,219.13</td>
                ...
                <tr>
                  <th scope="row">
                  <div className="coll_list_pp">
                    <img className="lazy" src="/static/img/author/author-8.jpg" alt=""/>
                    <i className="fa fa-check"></i>
                  </div>  
                  RockToonz</th>
                  <td>8,436.15</td>
