...
render() {
    return (
      ...
      <GlobalStyles/>
        ...
        <section className='jumbotron breadcumb no-bg' style={{backgroundImage: `url(${'/static/img/background/subheader.jpg'})`}}>
          <div className='mainbreadcumb'>
            <div className='container'>
              <div className='row m-10-hor'>
                <div className='col-12'>
                  <h1 className='text-center'>Create Multiple NFTs</h1>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-sm-6 col-xs-12">
                  ...
                  <div className="nft__item m-0">
                      ...
                      <div className="nft__item_wrap">
                          <span>
                              <img src="/static/img/collections/coll-item-3.jpg" id="get_file_2" className="lazy nft__item_preview" alt=""/>
                          </span>
                      </div>
